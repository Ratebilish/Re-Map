...
if !A_IsAdmin
{
  ...
  IniRead, h1, %A_WorkingDir%\Hotkeys.ini, Inventory, item1, %A_Space%
  IniRead, h2, %A_WorkingDir%\Hotkeys.ini, Inventory, item2, %A_Space%
  IniRead, h3, %A_WorkingDir%\Hotkeys.ini, Inventory, item3, %A_Space%
  IniRead, h4, %A_WorkingDir%\Hotkeys.ini, Inventory, item4, %A_Space%
  IniRead, h5, %A_WorkingDir%\Hotkeys.ini, Inventory, item5, %A_Space%
  IniRead, h6, %A_WorkingDir%\Hotkeys.ini, Inventory, item6, %A_Space%


  IniRead, h7, %A_WorkingDir%\Hotkeys.ini, Others, LearnSkills, CapsLock
  IniRead, h8, %A_WorkingDir%\Hotkeys.ini, Others, Scoreboard, ``
  IniRead, sbX, %A_WorkingDir%\Hotkeys.ini, Others, sbX,%A_Space%
  IniRead, sbY, %A_WorkingDir%\Hotkeys.ini, Others, sbY,%A_Space%
  IniRead, h9, %A_WorkingDir%\Hotkeys.ini, Others, Autocast, !F
  IniRead, h10, %A_WorkingDir%\Hotkeys.ini, Others, Hold, %A_Space%

  IniRead, DONTshowConfig, %A_WorkingDir%\Hotkeys.ini, Others, DONTshowConfig, 0
  IniRead, TMPHIDE, %A_WorkingDir%\Hotkeys.ini, Others,TMPHIDE, 0
  IniRead, ShieldLWin, %A_WorkingDir%\Hotkeys.ini, Others, ShieldLWin, 0
  IniRead, RunAtStart, %A_WorkingDir%\Hotkeys.ini, Others, RunAtStart, 0
  IniRead, CustomGroups, %A_WorkingDir%\Hotkeys.ini, Others, CustomGroups, 0

  IniRead, Toggle, %A_WorkingDir%\Hotkeys.ini, Others, Toggle, Home

  IniRead, WMC, %A_WorkingDir%\Hotkeys.ini, Others, WMC, 0
  if WMC {
  ...
  loop {
	  i:=A_Index+10
	  IniRead, h%i%, %A_WorkingDir%\Hotkeys.ini, Messages, hotkey%A_Index%, %A_Space%
	  if h%i% {
		  vh%i%:=VK(h%i%)
		  Hotkey, % vh%i%, Message%A_Index%
		  IniRead, Mes%A_Index%, %A_WorkingDir%\Hotkeys.ini, Messages, message%A_Index%
		  IniRead, toAll%A_Index%, %A_WorkingDir%\Hotkeys.ini, Messages, toAll%A_Index%,0
...
if TMPHIDE {
EmptyMem()
IniWrite, 0, %A_WorkingDir%\Hotkeys.ini, Others, TMPHIDE
return
}
if DONTshowConfig
{
...
if %configCreated%
{
gui, show, autosize center, Re:Map 0.0.3
}
else {
Gui 1:Default
Gui, Add, Tab2, y0 h190, Inventory|Others|Messages
Gui, Tab, Inventory
...
Mes_KeyUpdate:
  Mes_KeyList=
  loop {
  IniRead, HM, Hotkeys.ini, Messages, hotkey%A_Index%, %A_Space%
  if HM
...
Mes_MesUpdate:
gui, submit, nohide
IniRead, M, %A_WorkingDir%\Hotkeys.ini, Messages, message%Mes_Key%, %A_Space%
IniRead, H, %A_WorkingDir%\Hotkeys.ini, Messages, hotkey%Mes_Key%, %A_Space%
StringReplace, M, M,\n,`n, All
...
loop {
IniRead, h, Hotkeys.ini, Messages, hotkey%A_Index%, %A_Space%
  if !h
  {
  i=%A_Index%
  break
...
IniWrite, %HotkeyChoose_Mes%, %A_WorkingDir%\Hotkeys.ini, Messages, hotkey%i%
b:=i+10
h%b%:=HotkeyChoose_Mes
IniWrite, %MesEdit%, %A_WorkingDir%\Hotkeys.ini, Messages, message%i%
if toAll
IniWrite, 1, %A_WorkingDir%\Hotkeys.ini, Messages, toAll%i%
GUIControl ,,toAll,0
gosub, Mes_KeyUpdate
...
gui, submit, nohide
if HotkeyChoose_Mes
IniWrite, %HotkeyChoose_Mes%, %A_WorkingDir%\Hotkeys.ini, Messages, hotkey%Mes_Key%
StringReplace, MesEdit, MesEdit,`n,\n, All
IniWrite, %MesEdit%, %A_WorkingDir%\Hotkeys.ini, Messages, message%Mes_Key%
if toAll%Mes_Key%
IniWrite, 1, %A_WorkingDir%\Hotkeys.ini, Messages, toAll%Mes_Key%
else
IniWrite, 0, %A_WorkingDir%\Hotkeys.ini, Messages, toAll%Mes_Key%
GUIControl ,,toAll,0
gosub, Mes_KeyUpdate
GUIControl ,,HotkeyChoose_Mes,Hotkey
HotkeyChoose_Mes=
...
::/setsb::
MouseGetPos, xp, yp
IniWrite, %xp%, %A_WorkingDir%\Hotkeys.ini, Others, sbX
IniWrite, %yp%, %A_WorkingDir%\Hotkeys.ini, Others, sbY
IniWrite, 1, %A_WorkingDir%\Hotkeys.ini, Others, TMPHIDE
send {vk0D}
reload
return

::/unsetsb::
IniDelete, %A_WorkingDir%\Hotkeys.ini, Others, sbX
IniDelete, %A_WorkingDir%\Hotkeys.ini, Others, sbY
IniWrite, 1, %A_WorkingDir%\Hotkeys.ini, Others, TMPHIDE
send {vk0D}
reload
return
...
WriteIni:
  IniWrite, %h1%, %A_WorkingDir%\Hotkeys.ini, Inventory, item1
  IniWrite, %h2%, %A_WorkingDir%\Hotkeys.ini, Inventory, item2
  IniWrite, %h3%, %A_WorkingDir%\Hotkeys.ini, Inventory, item3
  IniWrite, %h4%, %A_WorkingDir%\Hotkeys.ini, Inventory, item4
  IniWrite, %h5%, %A_WorkingDir%\Hotkeys.ini, Inventory, item5
  IniWrite, %h6%, %A_WorkingDir%\Hotkeys.ini, Inventory, item6

  IniWrite, %h7%, %A_WorkingDir%\Hotkeys.ini, Others, LearnSkills
  IniWrite, %h8%, %A_WorkingDir%\Hotkeys.ini, Others, ScoreBoard
  IniWrite, %h9%, %A_WorkingDir%\Hotkeys.ini, Others, Autocast

  IniWrite, %h10%, %A_WorkingDir%\Hotkeys.ini, Others, Hold

  IniWrite, %DONTshowConfig%, %A_WorkingDir%\Hotkeys.ini, Others, DONTshowConfig
  IniWrite, %ShieldLWin%, %A_WorkingDir%\Hotkeys.ini, Others, ShieldLWin
  IniWrite, %RunAtStart%, %A_WorkingDir%\Hotkeys.ini, Others, RunAtStart
  IniWrite, %CustomGroups%, %A_WorkingDir%\Hotkeys.ini, Others, CustomGroups

  IniWrite, %Toggle%, %A_WorkingDir%\Hotkeys.ini, Others, Toggle
return
...
SetWMC:
WMC:=!WMC
IniWrite, %WMC%, %A_WorkingDir%\Hotkeys.ini, Others, WMC
